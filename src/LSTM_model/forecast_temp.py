...
def model():
    """
    Fixture for loading the pre-trained LSTM model for temperature forecasting.
    """
    input_size = 421
    hidden_size = 421
    output_size = 1
    ...
    model.load_state_dict(torch.load('Temperature_forecast_model_combined_loss.pt'))
    return model

@pytest.fixture
def test_loader():
    """
    Fixture for loading the test dataset for temperature forecasting.
    """
    batch_size = 32
